        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "INTEGER", nullable: false),
                    Relationship = table.Column<int>(type: "INTEGER", nullable: false),
                    DependentStatus = table.Column<int>(type: "INTEGER", nullable: false),
                    Gender = table.Column<int>(type: "INTEGER", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BenefitsAmount = table.Column<decimal>(type: "TEXT", nullable: false),
                    AdditionalBenefitCost = table.Column<decimal>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeePayPeriods_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeePayPeriods_PayrollPeriods_PayrollPeriodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeePayPeriods_EmployeeId",
                table: "EmployeePayPeriods",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeePayPeriods_PayrollPeriodId",
                table: "EmployeePayPeriods",
